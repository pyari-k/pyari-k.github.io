...
For this, we need to import both the data sets and blend the data with a join on the id field. Images showing how this can be achieved is placed below. 
